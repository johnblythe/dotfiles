...
After creating the WORKING.md file, output EXACTLY this format:
...
/compact [printf your specific instruction based on our work]

🏃‍♂️‍➡️ Next Steps:
Use `context/WORKING.md` to continue development.
```

DO NOT add ANY other text. NO bullets, NO summaries, NO explanations.
The /compact command MUST be on its own line for easy copy/paste.

Note: SessionStart hook will auto-inject WORKING.md after compact.
